            ...
            modelBuilder.Entity("RepositoryPattern.Core.Book", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 23, 13, 35, 52, 440, DateTimeKind.Utc).AddTicks(4349));
            ...
            modelBuilder.Entity("RepositoryPattern.Core.CaretItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 13, 35, 52, 440, DateTimeKind.Utc).AddTicks(7882));
            ...
            modelBuilder.Entity("RepositoryPattern.Core.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 13, 35, 52, 441, DateTimeKind.Utc).AddTicks(89));
            ...
            modelBuilder.Entity("RepositoryPattern.Core.OrderDetail", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 13, 35, 52, 441, DateTimeKind.Utc).AddTicks(1336));

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 13, 35, 52, 441, DateTimeKind.Utc).AddTicks(1641));
            ...
            modelBuilder.Entity("RepositoryPattern.Core.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 13, 35, 52, 441, DateTimeKind.Utc).AddTicks(2915));
            ...
            modelBuilder.Entity("RepositoryPattern.Core.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 13, 35, 52, 442, DateTimeKind.Utc).AddTicks(9127));
            ...
            modelBuilder.Entity("RepositoryPattern.Core.ShoppingSession", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 13, 35, 52, 443, DateTimeKind.Utc).AddTicks(275));
